(() => {
  ...
  const initial = {
    ...
    attention: { list: [] },
    preferences: { theme: 'light-bone', lightTheme: 'light-bone', darkTheme: 'dark-3', font: 'default', compact: false, messageNumbers: false, notifications: true, chime: false, dictation: true },
  };
