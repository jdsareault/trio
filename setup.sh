...
# Tool base names (23 tools)
TOOL_BASES=(connect send dm poll ack pounds ask claim complete cancel release lock unlock set_status rename status roster history end list cull cleanup retract)
...
echo "  python3 $SERVER_DIR/nth_web.py                  # unified local hub (http://127.0.0.1:8765/)"
echo "  python3 $SERVER_DIR/nth_web.py MYCHAN --tailnet # single-channel, reachable from tailnet peers"
echo "  python3 $SERVER_DIR/nth_launchd.py install      # macOS: start unified hub at login"
echo ""
